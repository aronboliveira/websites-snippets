function addWhatsAppKbShortcuts() {
    const queryAllElements = () => {
        ...
        allCb = (e) => {
            if (
                !((e.key.toLowerCase() === "q" || e.keyCode === 81) && e.altKey)
            )
                return;
            (
                document.getElementById("all-filter") ??
        ...
        unreadCb = (e) => {
            if (
                !((e.key.toLowerCase() === "w" || e.keyCode === 87) && e.altKey)
            )
                return;
            (
                document.getElementById("unread-filter") ??
        ...
        fvtCb = (e) => {
            if (
                !((e.key.toLowerCase() === "a" || e.keyCode === 65) && e.altKey)
            )
                return;
            (
                document.getElementById("favorites-filter") ??
        ...
        groupsCb = (e) => {
            if (
                !((e.key.toLowerCase() === "s" || e.keyCode === 83) && e.altKey)
            )
                return;
            (
                document.getElementById("group-filter") ??
        ...
        moreCb = (e) => {
            if (
                !((e.key.toLowerCase() === "m" || e.keyCode === 77) && e.altKey)
            )
                return;
        ...
        ngrpCb = (e) => {
            if (
                !((e.key.toLowerCase() === "n" || e.keyCode === 78) && e.altKey)
            )
                return;
